...
export default function DashboardPage() {
  ...
  const { isInitialized, miningStats } = useLayerTwoLabs()
          ...
          {isLoading ? (
            ...
            <motion.div className="space-y-6" variants={containerVariants} initial="hidden" animate="visible">
              ...
              {isInitialized && (
                <motion.div variants={itemVariants}>
                  <div className="flex items-center justify-between mb-3">
                    <h2 className="text-lg font-bold">Activity Mining</h2>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="font-medium">Mining Status</span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-3">
                        <div>
                          ...
                          <p className="font-medium">{miningStats?.totalRewards || "0"} ACTIVE</p>
                        </div>
                        <div>
                          <p className="text-xs text-zinc-400">Activities Mined</p>
                          <p className="font-medium">{miningStats?.totalActivities || "0"}</p>
                        </div>
                      </div>
              ...
              {/* Bitcoin Signet Mining Section */}
              <motion.div variants={itemVariants}>
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-lg font-bold">Bitcoin Signet Mining</h2>
                ...
                <Card className="bg-zinc-900 border-zinc-800">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <h3 className="font-medium">Bitcoin Signet with BIP300/301</h3>
                        <p className="text-xs text-zinc-400">Mine on Bitcoin Signet with LayerTwoLabs integration</p>
                      </div>
                    </div>
                    <Link href="/bitcoin-mining">
                      <Button className="w-full">Set Up Mining</Button>
              ...
              {activeBoosts.length > 0 && (
                <Card className="bg-zinc-900 border-zinc-800 mb-6">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {activeBoosts.slice(0, 2).map((boost) => (
                        <div key={boost.id} className="bg-zinc-800 rounded-lg p-3">
                          ...
                          <div className="flex justify-between text-xs text-zinc-400">
                            <span>{boost.networkId === "all" ? "All Networks" : boost.networkId}</span>
                            {boost.endTime && (
                              <span>
                                {Math.max(0, Math.floor((boost.endTime - Date.now()) / (60 * 60 * 1000)))}h remaining
                              </span>
                            )}
                          </div>
                        </div>
                      ...
                      {activeBoosts.length > 2 && (
                        <div className="text-center text-xs text-zinc-400">
                          +{activeBoosts.length - 2} more active boosts
                        </div>
                      )}
                    </div>
                  </CardContent>
